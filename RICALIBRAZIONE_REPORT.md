# Report di ricalibrazione automatica — 2026-09-01

Estrazioni analizzate: 2910. Campione di test per il rank isolato: ultime 1200.
...
- **hotWindow=15**: migliora in 3/6 posizioni (z per posizione: 0.66, 0.60, -0.35, -0.32, 0.00, 1.70)
- **hotWindow=20**: migliora in 4/6 posizioni (z per posizione: 1.57, 0.53, 1.02, -0.27, -0.45, 3.92)
- **decadeWindow=15**: migliora in 4/6 posizioni (z per posizione: -1.41, 0.83, 0.28, 0.79, -0.16, 2.54)
- **decadeWindow=25**: migliora in 5/6 posizioni (z per posizione: 0.69, 0.33, -0.96, 1.67, 0.46, 2.19)
- **decadeWindow=30**: migliora in 3/6 posizioni (z per posizione: -0.16, -0.30, 1.15, 2.06, -0.65, 2.16)
- **clusterMaxLag=3**: migliora in 6/6 posizioni (z per posizione: 1.51, 0.63, 0.50, 1.34, 0.28, 0.83)
- **clusterMaxLag=7**: migliora in 2/6 posizioni (z per posizione: -0.28, -1.00, -0.38, 0.45, -0.28, 0.58)
- **clusterMaxLag=10**: migliora in 2/6 posizioni (z per posizione: -0.69, -1.26, -0.73, 0.63, -0.24, 0.45)
- **volWindow=15**: migliora in 3/6 posizioni (z per posizione: -1.96, 1.40, 0.00, 0.78, -0.37, 1.73)
- **volWindow=25**: migliora in 5/6 posizioni (z per posizione: -1.15, 0.47, 0.30, 0.26, 1.07, 1.00)
- **coldWindow=5**: migliora in 2/6 posizioni (z per posizione: -2.69, -0.62, -1.12, 1.41, -0.63, 0.69)
- **coldWindow=15**: migliora in 5/6 posizioni (z per posizione: 0.12, 0.50, -0.61, 0.23, 2.29, 1.52)
- **coldWindow=20**: migliora in 3/6 posizioni (z per posizione: -1.33, 0.33, -0.10, -0.29, 1.04, 1.91)
